...
<img src="images/sheets-option-drag.png" alt="Caption here, with embedded link to [animated GIF](https://handsondataviz.github.io/bookdown-template/images/sheets-option-drag.gif)."  />
<p class="caption">
