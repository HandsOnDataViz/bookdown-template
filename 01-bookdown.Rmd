...
(ref:excel-drag) Caption here, with embedded link to [animated GIF](https://handsondataviz.github.io/bookdown-template/excel-drag.gif).

<!-- set iframe 450px height in custom-scripts.html -->
```{r excel-drag, fig.cap="(ref:excel-drag)"}
if(knitr::is_html_output()) knitr::include_url("https://handsondataviz.github.io/bookdown-template/excel-drag.gif") else knitr::include_graphics("images/excel-drag.png")
```
