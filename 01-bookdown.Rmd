...
```{r screenshot-tall, fig.cap="(ref:screenshot-tall)"}
...
```{r screenshot-tall2, out.width=200, fig.cap="(ref:screenshot-tall2)"}
 knitr::include_graphics("images/screenshot-tall.png")
```
...
```{r screenshot-tall3, out.width=200, dpi=300, fig.cap="(ref:screenshot-tall3)"}
 knitr::include_graphics("images/screenshot-tall.png")
```
...
```{r screenshot-tall4, out.width=200, fig.cap="(ref:screenshot-tall4)"}
 knitr::include_graphics("images/screenshot-tall.png")
```
