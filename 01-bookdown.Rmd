...
(ref:video-sample) Caption here, with embedded link to [YouTube video](https://youtu.be/-nGdrzMuUnI).

```{r video-sample, fig.cap="(ref:video-sample)"}
if(knitr::is_html_output()) knitr::include_url("https://youtu.be/-nGdrzMuUnI") else knitr::include_graphics("images/video-sample.png")
```
