...
...as shown in Figure \@ref(fig:screenshot-tall).

(ref:screenshot-tall) Testing how this appears without out.width.

```{r screenshot-tall, fig.pos='h', fig.cap="(ref:screenshot-tall)"}
 knitr::include_graphics("images/screenshot-tall.png")
```

### TESTING with out.width=200 in HTML and PDF
...as shown in Figure \@ref(fig:screenshot-tall2).

(ref:screenshot-tall2) Testing how this appears with out.width.

```{r screenshot-tall2, out.width=200, fig.pos='h', fig.cap="(ref:screenshot-tall2)"}
 knitr::include_graphics("images/screenshot-tall.png")
```

### TESTING with out.width=200 and dpi=300 (installed PNG package) in HTML and PDF
...as shown in Figure \@ref(fig:screenshot-tall3).

(ref:screenshot-tall3) Testing outwidth and dpi together.

```{r screenshot-tall3, out.width=200, dpi=300, fig.pos='h', fig.cap="(ref:screenshot-tall3)"}
 knitr::include_graphics("images/screenshot-tall.png")
```

### TESTING with out.width=200 and auto-even-smaller-pdf in HTML and PDF
...as shown in Figure \@ref(fig:screenshot-tall4).

(ref:screenshot-tall4) Testing outwidth and auto smaller pdf together.

```{r screenshot-tall4, out.width=200, fig.pos='h', fig.cap="(ref:screenshot-tall4)"}
 knitr::include_graphics("images/screenshot-tall.png")
```
...
if(knitr::is_html_output()) knitr::include_url("images/sheets-option-drag.gif", height = "250px") else knitr::include_graphics("images/sheets-option-drag.png")
```
