...
TODO: FIX to make this appear consistently in all browsers; shorter pathname.

...as shown in Figure \@ref(fig:excel-drag).

(ref:excel-drag) Caption here, with embedded link to GitHub repo, not GitHub Pages [animated GIF](https://github.com/HandsOnDataViz/bookdown-template/blob/master/images/excel-drag.gif).

<!-- set iframe 450px height in custom-scripts.html -->
```{r excel-drag, fig.cap="(ref:excel-drag)"}
if(knitr::is_html_output()) knitr::include_url("images/excel-drag.gif") else knitr::include_graphics("images/excel-drag.png")
```
...
if(knitr::is_html_output()) knitr::include_url("https://www.youtube.com/embed/-nGdrzMuUnI") else knitr::include_graphics("images/video-sample.png")
```
